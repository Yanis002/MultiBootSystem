...
inline void J3DGXCmd1f32ptr(f32* value) { GXWGFifo.u32 = *(u32*)value; }
...
void J3DGDSetTexLookupMode(GXTexMapID, GXTexWrapMode, GXTexWrapMode, GXTexFilter, GXTexFilter, f32, f32, f32, u8, u8,
                           GXAnisotropy);
...
void J3DGDSetIndTexOrder(u32, GXTexCoordID, GXTexMapID, GXTexCoordID, GXTexMapID, GXTexCoordID, GXTexMapID,
...
inline void J3DGDSetBlendMode(GXBlendMode mode, GXBlendFactor srcFactor, GXBlendFactor dstFactor, GXLogicOp logicOp) {
    ...
    J3DGDWriteBPCmd((mode == GX_BM_BLEND || mode == GX_BM_SUBTRACT) << 0 | (mode == GX_BM_LOGIC) << 1 | dstFactor << 5 |
...
inline void J3DGDSetBlendMode(GXBlendMode mode, GXBlendFactor srcFactor, GXBlendFactor dstFactor, GXLogicOp logicOp,
    ...
    J3DGDWriteBPCmd(u32(mode == GX_BM_BLEND || mode == GX_BM_SUBTRACT) << 0 | (mode == GX_BM_LOGIC) << 1 |
                    ditherEnable << 2 | dstFactor << 5 | srcFactor << 8 | (mode == GX_BM_SUBTRACT) << 11 |
                    logicOp << 12 | 0x41 << 24);
}
...
inline void J3DGDSetTevKonstantSel_SwapModeTable(GXTevStageID stage, GXTevKColorSel colorSel1, GXTevKAlphaSel alphaSel1,
                                                 GXTevKColorSel colorSel2, GXTevKAlphaSel alphaSel2,
                                                 GXTevColorChan chan1, GXTevColorChan chan2) {
    J3DGDWriteBPCmd((stage / 2 + 0xf6) << 24 |
                    (chan1 | chan2 << 2 | colorSel1 << 4 | alphaSel1 << 9 | colorSel2 << 14 | alphaSel2 << 19) &
                        0x00FFFFFF);
}
