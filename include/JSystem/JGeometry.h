...
namespace JGeometry {
    ...
    template <> struct TVec3<s16> : public SVec {
        // s16 x, y, z;
    ...
    template <> struct TVec3<f32> : public Vec {
        ...
        f32 dot(const TVec3<f32>& b) const { return x * b.x + y * b.y + z * b.z; }
        ...
        template <typename S>
        void cubic(const JGeometry::TVec3<f32>& vec1, const JGeometry::TVec3<f32>& vec2,
                   const JGeometry::TVec3<f32>& vec3, const JGeometry::TVec3<f32>& vec4, f32 f19) {
