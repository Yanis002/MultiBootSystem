...
class J2DScreen : public J2DPane {
  public:
    J2DScreen(J2DPane* parent, bool visible, u32 tag, const JGeometry::TBox2<f32>& bounds)
        : J2DPane(parent, visible, tag, bounds), mColor() {
        mbClipToParent = false;
    }

    J2DScreen() : J2DPane(NULL, true, 'root', JGeometry::TBox2<f32>(0.0f, 0.0f, 640.0f, 480.0f)), mColor() {
        mbClipToParent = false;
    }
    ...
    virtual J2DPane* createPane(J2DPane::J2DScrnBlockHeader const& header, JSURandomInputStream* pStream,
                                J2DPane* pParent);
