...
namespace JStudio {
    ...
    struct TVariableValue {
        ...
        void setValue_none() { field_0x8 = NULL; }
        ...
        template <typename T> T getValue_clamp() const {
            f32 val = mValue;
    ...
    class TObject : public stb::TObject {
      public:
        ...
        template <class T> T* createFromAdaptor(const stb::data::TParse_TBlock_object& param_0, T* param_1) {
    ...
    struct TAdaptor {
        inline TAdaptor(TVariableValue* values, int count) : mVariableValues(values), mCount(count) {}

        struct TSetVariableValue_immediate {
            inline TSetVariableValue_immediate(u32 p1, f32 p2) : field_0x0(p1), field_0x4(p2) {}
        ...
        void adaptor_setVariableValue_n(JStudio::TObject*, u32 const*, u32, JStudio::data::TEOperationData, void const*,
                                        u32);
        ...
        static void adaptor_setVariableValue_VOID_(JStudio::TAdaptor*, JStudio::TObject*, u32, void const*, u32);
        static void adaptor_setVariableValue_IMMEDIATE_(JStudio::TAdaptor*, JStudio::TObject*, u32, void const*, u32);
        static void adaptor_setVariableValue_TIME_(JStudio::TAdaptor*, JStudio::TObject*, u32, void const*, u32);
        static void adaptor_setVariableValue_FVR_NAME_(JStudio::TAdaptor*, JStudio::TObject*, u32, void const*, u32);
        static void adaptor_setVariableValue_FVR_INDEX_(JStudio::TAdaptor*, JStudio::TObject*, u32, void const*, u32);

        TVariableValue* adaptor_referVariableValue(u32 param_0) { return &mVariableValues[param_0]; }
        ...
        const TVariableValue* adaptor_getVariableValue(u32 param_0) const { return &mVariableValues[param_0]; }
    ...
    struct TAdaptor_actor : public TAdaptor {
        TAdaptor_actor() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_ambientLight : public TAdaptor {
        TAdaptor_ambientLight() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_camera : public TAdaptor {
        TAdaptor_camera() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_fog : public TAdaptor {
        TAdaptor_fog() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_light : public TAdaptor {
        TAdaptor_light() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_particle : public TAdaptor {
        TAdaptor_particle() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
    ...
    struct TAdaptor_sound : public TAdaptor {
        ...
        TAdaptor_sound() : TAdaptor(mValue, ARRAY_COUNT(mValue)), mValue() {}
