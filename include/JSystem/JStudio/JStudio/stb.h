    ...
    namespace stb {
        ...
        class TObject : public object::TObject_ID {
          public:
            ...
            void on_data(const void* arg1, u32 arg2, const void* arg3, u32 arg4) { do_data(arg1, arg2, arg3, arg4); }
        ...
        template <int T> struct TParseData {
            ...
            bool isEnd() const { return m_data->_0 == 0; }

            bool empty() const { return m_data->_c == NULL; }

            bool isValid() const { return !empty() && m_data->_0 == 50; }

            data::TParse_TParagraph_data::TData* m_data;
        };

        template <int T> struct TParseData_fixed : public TParseData<T> {
            TParseData_fixed(const void* pContent) : TParseData(pContent) {}

            const void* getNext() const { return m_data->_c; }

            bool isValid() const { return TParseData::isValid() && getNext() != NULL; }
        };
