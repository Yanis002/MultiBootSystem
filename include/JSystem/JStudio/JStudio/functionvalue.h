...
namespace JStudio {
    ...
    class TFunctionValue_list : public TFunctionValue,
      ...
      public:
        ...
        static f64 update_INTERPOLATE_NONE_(JStudio::TFunctionValue_list const&,
                                            JStudio::TFunctionValue_list::TIndexData_ const&);
        static f64 update_INTERPOLATE_LINEAR_(JStudio::TFunctionValue_list const&,
                                              JStudio::TFunctionValue_list::TIndexData_ const&);
        static f64 update_INTERPOLATE_PLATEAU_(JStudio::TFunctionValue_list const&,
                                               JStudio::TFunctionValue_list::TIndexData_ const&);
        static f64 update_INTERPOLATE_BSPLINE_dataMore3_(JStudio::TFunctionValue_list const&,
                                                         JStudio::TFunctionValue_list::TIndexData_ const&);
    ...
    class TFunctionValue_list_parameter : public TFunctionValue,
      ...
      public:
        ...
        f64 data_getValue_back() { return pfData_[(uData_ - 1) * 2]; }
    ...
    class TFunctionValue_hermite : public TFunctionValue, public TFunctionValueAttribute_range {
      public:
        ...
        f64 data_getValue_back() { return pf_[(u_ - 1) * uSize_]; }
