...
#define MMCR0_PMC1_Bx_STALL_CYCLE \
    0x00000300 // # of cycles that dispatcher stalls due to a second
...
#define MMCR1_PMC3_Bx_SECOND \
    0x80000000 // # of branches in the second speculative branch
               //   resolved correctly
#define MMCR1_PMC3_BPU_LR_CR \
    0x88000000 // # of cycles the BPU stalls due to LR or CR unresolved
               //   dependencies
...
#define MMCR1_PMC4_COND_STORE_INT \
    0x02800000 // # of store conditional instructions completed
...
#define MMCR1_PMC4_BPU_THIRD \
    0x03800000 // # of cycles the BPU cannot process new branches
